...
class GradePredictor:
    ...
    def calculate_slope(self, predicted_grade):
        ...
        months, grades = zip(*predicted_grade)
    ...
    def calculate_intercept(self, predicted_grade, slope):
        n = len(predicted_grade)
        sum_x = sum(x for x, y in predicted_grade)
        sum_y = sum(y for x, y in predicted_grade)
...
if __name__ == "__main__":
    ...
    final_months = 6
    predicted_final_grade = grade_predictor.predict_final_grade(final_months)
